...
// isIndexOptions: when true, bot reads underlying (underlyingToken) for signals and auto-resolves an option at runtime.
// underlyingToken: the index token used to fetch candles and generate signals (only for isIndexOptions instruments).
// The existing resolver selects the closest available one-strike ITM CE/PE option at trade time.
// This is a display clarification only; selector behavior remains unchanged.
// Quantity is sized using the option PREMIUM price (~₹100–500), NOT the underlying futures price.
const INSTRUMENTS = [
  // ── NSE Index Options — Auto ITM ─────────────────────────────────────────────
  ...
  // ── MCX Commodity Options — Auto ITM ─────────────────────────────────────────
  ...
  { token: "MCX_FO|555922",  symbol: "MCX_GOLD",   label: "Gold → ITM Options (Auto)",         segment: "MCX Commodity Options", lotSize: 100,  spotOnly: false, isIndexOptions: true, underlyingToken: "MCX_FO|555922" },
  ...
  { token: "MCX_FO|538685",  symbol: "MCX_NATGAS", label: "Natural Gas → ITM Options (Auto)",  segment: "MCX Commodity Options", lotSize: 1250, spotOnly: false, isIndexOptions: true, underlyingToken: "MCX_FO|538685" },
  { token: "MCX_FO|562048",  symbol: "MCX_COPPER", label: "Copper → ITM Options (Auto)",       segment: "MCX Commodity Options", lotSize: 2500, spotOnly: false, isIndexOptions: true, underlyingToken: "MCX_FO|562048" },
];
              ...
              <div key={bot.sessionToken} className={`rounded-xl sm:rounded-2xl border p-2 sm:p-4 transition-all duration-300 ${
                ...
                {isActive ? (
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    >
                      <optgroup label="Index Options — auto ITM CE/PE">
                      ...
                      <optgroup label="MCX Options — auto ITM CE/PE">
