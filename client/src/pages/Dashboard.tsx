  ...
  const handleQuickStart = (slot: number) => {
    ...
    if (slot === 0) {
      ...
      startSecondaryMutation.mutate({
        ...
        mode: config.mode, capital: qs.capital, riskPerTradePct: 1.5, maxTradesPerDay: 0,
    ...
    try {
      ...
      if (slot === 0) {
        ...
        await startSecondaryMutation.mutateAsync({
          ...
          mode: config.mode, capital: newCapital, riskPerTradePct: 1.5, maxTradesPerDay: 0,
          dailyLossLimitPct: 3, stopLossMultiplier: 1.5, targetMultiplier: 2.5,
          minConfidence: 60, scanIntervalSec: 30,
          lotSize: resolved.lotSize,
          isIndexOptions: true,
                                ...
                                onClick={() => {
                                  ...
                                  if (bot.slot === 0) {
                                    startMutation.mutate({
                                      ...
                                      riskPerTradePct: 1.5, maxTradesPerDay: 0, dailyLossLimitPct: 3,
