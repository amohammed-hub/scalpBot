          ...
          <div className="mt-5 p-5 bg-gradient-to-br from-white/5 to-white/[0.02] rounded-xl border border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
             ...
             <button
              ...
              {/* Red Bar Theory Card */}
             <button
                onClick={() => toggleLayer("RedBarTheory")}
                className={`relative p-4 rounded-xl border-2 text-left transition-all ${
                  config.enabledLayers.includes("RedBarTheory")
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-lg">🧱</span>
                  <span className="font-bold text-white text-sm">Red Bar Theory</span>
                  <span className="text-[9px] bg-orange-500/20 text-orange-400 px-1.5 py-0.5 rounded font-bold">NEW</span>
                </div>
                <p className="text-[11px] text-white/50 leading-relaxed">
                  Red Bar Theory — noise-filtered trend detection using Renko bricks. Enters on 3 consecutive same-direction bricks.
                </p>
