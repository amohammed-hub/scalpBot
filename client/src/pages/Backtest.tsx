...
const INSTRUMENTS = [
  ...
  { token: "MCX_FO|563946",                label: "Gold futures — option signal underlying" },
  ...
  { token: "MCX_FO|561496",                label: "Natural Gas futures — option signal underlying" },
  { token: "MCX_FO|568831",                label: "Copper futures — option signal underlying" },
