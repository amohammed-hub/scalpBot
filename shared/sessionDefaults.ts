...
const EVENING_DEFAULTS: InstrumentDefault[] = [
  { token: "MCX_FO|552720",  symbol: "MCX_GOLD",   label: "Gold → OTM Options (Auto)",         lotSize: 100, isIndexOptions: true, underlyingToken: "MCX_FO|552720" },
  { token: "MCX_FO|520702",  symbol: "MCX_CRUDE",  label: "Crude Oil → OTM Options (Auto)",    lotSize: 100, isIndexOptions: true, underlyingToken: "MCX_FO|520702" },
